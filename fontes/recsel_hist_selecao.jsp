...
<report name="recsel_hist_selecao" DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="RECSEL_HIST_SELECAO" xmlPrologType="text">
  ...
  <data>
    ...
    <dataSource name="Q_1">
      ...
      <![CDATA[SELECT c.candidato_nome,
       c.candidato_cpf,
	   r.selecao_numero as recrutamento_numero,
	   r.selecao_ano as recrutamento_ano,
	   r.selecao_descricao as recrutamento_descricao,
	   decode(r.selecao_status,'A','Arquivado',
	                                'C','Cancelado',
									'E','Elaboração',
									'I','Período de Inscrições',
									'N','Inscrições encerradas',
									'P','Publicado',
									'R','Publicação de Resultados',
									'S','Suspenso') AS recrutamento_status,
       r.selecao_dt_resultado as recrutamento_dt_encerra,
	   cf.cargo_funcao_nome,
	   ec.sel_etapa_cand_nota as rec_etapa_cand_nota,
	   decode(ec.sel_etapa_cand_aprov,'S','Aprovado','N','Reprovado') AS rec_etapa_cand_aprov,
	   se.sts_etapa_nome,
	   e.etapasel_nome as etaparec_nome 
  FROM recsel_sel_etapa_candidato ec,
              recsel_candidato c,
	   recsel_selecao r,
	   recsel_cargo_funcao cf,	   
	   recsel_sts_etapa_sel se,
	   recsel_etapasel e
 WHERE ec.candidato_cpf = c.candidato_cpf
   AND ec.selecao_id = r.selecao_id
   AND r.cargo_funcao_id = cf.cargo_funcao_id
   AND ec.etapasel_id = se.etapasel_id
   AND ec.sts_etapa_sel_id = se.sts_etapa_sel_id
   AND se.etapasel_id = e.etapasel_id
   AND ec.candidato_cpf = nvl(:p_cpf,ec.candidato_cpf)]]>
      </select>
      ...
      <group name="G_candidato_nome">
        ...
        <dataItem name="candidato_cpf" oracleDatatype="number"
         ...
         defaultHeight="10000" columnFlags="1" defaultLabel="Candidato Cpf">
          <dataDescriptor expression="c.candidato_cpf"
           descriptiveExpression="CANDIDATO_CPF" order="2"
           oracleDatatype="number" width="22" precision="11"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
      <group name="G_recrutamento_numero">
        <displayInfo x="0.08850" y="1.42749" width="2.34412" height="1.28516"
        />
        <dataItem name="recrutamento_numero" oracleDatatype="number"
         ...
         defaultLabel="Recrutamento Numero">
          <dataDescriptor expression="r.selecao_numero"
           descriptiveExpression="RECRUTAMENTO_NUMERO" order="3"
        ...
        <dataItem name="recrutamento_ano" oracleDatatype="number"
         ...
         defaultLabel="Recrutamento Ano">
          <dataDescriptor expression="r.selecao_ano"
           descriptiveExpression="RECRUTAMENTO_ANO" order="4"
           oracleDatatype="number" width="22" precision="4"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="recrutamento_descricao" datatype="vchar2"
         ...
         defaultLabel="Recrutamento Descricao">
          <dataDescriptor expression="r.selecao_descricao"
           descriptiveExpression="RECRUTAMENTO_DESCRICAO" order="5"
           width="4000"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="recrutamento_status" datatype="vchar2"
         columnOrder="17" width="24" defaultWidth="100000"
         defaultHeight="10000" columnFlags="33"
         defaultLabel="Recrutamento Status">
          <dataDescriptor
           expression="decode ( r.selecao_status , &apos;A&apos; , &apos;Arquivado&apos; , &apos;C&apos; , &apos;Cancelado&apos; , &apos;E&apos; , &apos;Elaboração&apos; , &apos;I&apos; , &apos;Período de Inscrições&apos; , &apos;N&apos; , &apos;Inscrições encerradas&apos; , &apos;P&apos; , &apos;Publicado&apos; , &apos;R&apos; , &apos;Publicação de Resultados&apos; , &apos;S&apos; , &apos;Suspenso&apos; )"
           descriptiveExpression="RECRUTAMENTO_STATUS" order="6" width="24"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="recrutamento_dt_encerra" datatype="date"
         ...
         defaultLabel="Recrutamento Dt Encerra">
          <dataDescriptor expression="r.selecao_dt_resultado"
           descriptiveExpression="RECRUTAMENTO_DT_ENCERRA" order="7"
           oracleDatatype="date" width="9"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="cargo_funcao_nome" datatype="vchar2" columnOrder="19"
         width="100" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Cargo Funcao Nome">
          <dataDescriptor expression="cf.cargo_funcao_nome"
           descriptiveExpression="CARGO_FUNCAO_NOME" order="8" width="100"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
      <group name="G_rec_etapa_cand_nota">
        <displayInfo x="0.19836" y="3.05347" width="2.12439" height="0.94336"
        />
        <dataItem name="rec_etapa_cand_nota" oracleDatatype="number"
         columnOrder="20" width="22" defaultWidth="50000"
         defaultHeight="10000" columnFlags="32"
         defaultLabel="Rec Etapa Cand Nota" breakOrder="none">
          <dataDescriptor expression="ec.sel_etapa_cand_nota"
           descriptiveExpression="REC_ETAPA_CAND_NOTA" order="9"
        ...
        <dataItem name="rec_etapa_cand_aprov" datatype="vchar2"
         ...
         columnFlags="32" defaultLabel="Rec Etapa Cand Aprov"
         breakOrder="none">
          <dataDescriptor
           expression="decode ( ec.sel_etapa_cand_aprov , &apos;S&apos; , &apos;Aprovado&apos; , &apos;N&apos; , &apos;Reprovado&apos; )"
           descriptiveExpression="REC_ETAPA_CAND_APROV" order="10" width="9"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="sts_etapa_nome" datatype="vchar2" columnOrder="22"
         width="100" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Sts Etapa Nome">
          <dataDescriptor expression="se.sts_etapa_nome"
           descriptiveExpression="STS_ETAPA_NOME" order="11" width="100"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="etaparec_nome" datatype="vchar2" columnOrder="23"
         width="100" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Etaparec Nome">
          <dataDescriptor expression="e.etapasel_nome"
           descriptiveExpression="ETAPAREC_NOME" order="12" width="100"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
  ...
  <section name="main">
    <body width="8.23962" height="10.00000">
      ...
      <frame name="M_G_candidato_nome_GRPFR">
        <geometryInfo x="0.01038" y="0.00000" width="8.22913" height="5.51038"
        />
        ...
        <repeatingFrame name="R_G_candidato_nome" source="G_candidato_nome"
         ...
         columnMode="no">
          <geometryInfo x="0.01038" y="0.00000" width="8.22913"
           height="4.94788"/>
          <generalLayout verticalElasticity="variable"/>
          ...
          <frame name="M_G_recrutamento_numero_GRPFR">
            <geometryInfo x="0.01038" y="0.18750" width="8.22913"
             height="4.36462"/>
            <generalLayout verticalElasticity="variable"/>
            <repeatingFrame name="R_G_recrutamento_numero"
             ...
             maxRecordsPerPage="1" minWidowRecords="1" columnMode="no">
              <geometryInfo x="0.01038" y="0.19788" width="8.22913"
               height="4.19775"/>
              <generalLayout verticalElasticity="variable"/>
              <field name="F_recrutamento_numero" source="recrutamento_numero"
               minWidowLines="1" formatMask="FM0000" spacing="0"
               alignment="start">
              ...
              <field name="F_recrutamento_status" source="recrutamento_status"
               minWidowLines="1" spacing="0" alignment="start">
                <font face="Arial" size="10"/>
                <geometryInfo x="0.56226" y="0.97534" width="1.70862"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              ...
              <text name="B_recrutamento_dt_encerra" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="2.39502" y="0.96509" width="0.83325"
                 height="0.18750"/>
                <textSegment>
                  <font face="Arial" size="10" bold="yes"/>
                  <string>
              ...
              <field name="F_recrutamento_dt_encerra"
               ...
               formatMask="dd/mm/rrrr" spacing="0" alignment="start">
                <font face="Arial" size="10"/>
                <geometryInfo x="3.43750" y="0.97546" width="0.81250"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_recrutamento_descricao"
               ...
               alignment="start">
                <font face="Arial" size="10"/>
                <geometryInfo x="0.56458" y="1.34912" width="7.61267"
                 height="0.59790"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <frame name="M_G_rec_etapa_cand_nota_GRPFR">
                ...
                <advancedLayout printObjectOnPage="allPage"
                 ...
                 keepWithAnchoringObject="yes"/>
                <frame name="M_G_rec_etapa_cand_nota_HDR">
                  <geometryInfo x="0.01038" y="2.30078" width="8.00000"
                   height="0.18750"/>
                  <generalLayout verticalElasticity="variable"/>
                ...
                <repeatingFrame name="R_G_rec_etapa_cand_nota"
                 ...
                 minWidowRecords="1" columnMode="no">
                  <geometryInfo x="0.01038" y="2.49341" width="8.20837"
                   height="0.18750"/>
                  <generalLayout verticalElasticity="variable"/>
                  <advancedLayout printObjectOnPage="allPage"
                  ...
                  <field name="F_rec_etapa_cand_nota"
                   ...
                   alignment="start">
                    <font face="Arial" size="10"/>
                    <geometryInfo x="5.35510" y="2.49341" width="1.14587"
                     height="0.18750"/>
                    <generalLayout verticalElasticity="expand"/>
                    <advancedLayout printObjectOnPage="allPage"
                     basePrintingOn="enclosingObject"/>
                  ...
                  <field name="F_rec_etapa_cand_aprov"
                   ...
                   alignment="start">
                    <font face="Arial" size="10"/>
                    <geometryInfo x="6.53125" y="2.49341" width="1.68750"
                     height="0.18750"/>
                    <generalLayout verticalElasticity="expand"/>
                    <advancedLayout printObjectOnPage="allPage"
                     basePrintingOn="enclosingObject"/>
                  ...
                  <field name="F_sts_etapa_nome" source="sts_etapa_nome"
                   minWidowLines="1" spacing="0" alignment="start">
                    <font face="Arial" size="10"/>
                    <geometryInfo x="3.84583" y="2.49341" width="1.48962"
                     height="0.18750"/>
                    <generalLayout verticalElasticity="expand"/>
                    <advancedLayout printObjectOnPage="allPage"
                     basePrintingOn="anchoringObject"/>
                  ...
                  <field name="F_etaparec_nome" source="etaparec_nome"
                   minWidowLines="1" spacing="0" alignment="start">
                    <font face="Arial" size="10"/>
                    <geometryInfo x="0.01038" y="2.49341" width="2.91663"
                     height="0.18750"/>
                    <generalLayout verticalElasticity="expand"/>
                    <advancedLayout printObjectOnPage="allPage"
                     basePrintingOn="anchoringObject"/>
          ...
          <field name="F_candidato_cpf" source="candidato_cpf"
           ...
           spacing="0" alignment="start">
            <font face="Arial" size="12"/>
            <geometryInfo x="6.73962" y="0.00000" width="1.41687"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <text name="B_candidato_cpf" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="6.29761" y="0.00000" width="0.47888"
             height="0.18750"/>
            <textSegment>
              <font face="Arial" size="12" bold="yes"/>
              <string>
...
00000000
      ...
      <text name="B_14" minWidowLines="1">
        ...
        <textSegment>
          ...
          <string>
          <![CDATA[Histórico de seleções por candidato]]>
          </string>
        </textSegment>
      </text>
    </margin>
